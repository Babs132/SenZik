...
export default function AboutPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#020617]">
            <main className="flex-grow pt-32 px-6 text-white flex flex-col items-center justify-center relative overflow-hidden">
                ...
                >
                    ...
                    >
                        ...
                        SAMAZIK offre un accès instantané à des milliers d'artistes avec une interface moderne.
                    </motion.p>
            ...
            {/* FOOTER INTÉGRÉ ICI POUR ÊTRE SÛR QU'IL APPARAISSE */}
            <footer className="w-full border-t border-white/5 bg-black/40 backdrop-blur-xl py-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex flex-col items-center md:items-start">
                        <span className="text-2xl font-black italic text-white">SAMA<span className="text-orange-500">ZIK</span></span>
                        <p className="text-slate-500 text-[10px] uppercase font-bold tracking-[0.3em] mt-2">Music Experience Hub</p>
                    </div>
                    ...
                    <div className="flex gap-8 text-slate-400 text-[10px] font-black uppercase tracking-widest">
                        ...
                        <a href="#" className="hover:text-orange-500 transition-colors">Spotify</a>
